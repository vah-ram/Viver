...
import { Host, getMessageHost, addMessageHost, addContactHost, getUserHost } from "../Hosts.js"
  ...
  return (
    <>
        ...
        <section className='flex flex-row w-full'>
            ...
            <div className='w-full h-auto mt-[70px] ml-[220px] flex flex-row border-l-1 border-gray-300'>

                <div className='w-[300px] h-full flex flex-col  border-r-1 border-gray-300 pr-3 pl-3'>
...

                        {
                            ...
                            ?
                                <div className='w-full h-full flex flex-col'>
                                    ...
                                    <div 
                                        className='w-full flex flex-col p-3 gap-3 overflow-y-scroll' 
                                        style={{ height: "calc(100vh - 50px - 60px - 70px)"}}
                                        id='messages_div'>
                                            
                                        {
                                            messages.map(( u, i) => {
                                                if(u.from === currentUser._id) {
                                                    return (
                                                        <div id={i} className='px-3 py-2 rounded-tl-[15px] rounded-tr-[15px] rounded-bl-[15px] rounded-br-0 bg-[#9246d5ff] text-white w-fit max-w-[70%]  ml-auto'>
                                                            {u.message}
                                                        </div>
                                                    )
                                                } else {
                                                    return (
                                                        <div id={i} className='px-3 py-2 rounded-tl-[15px] rounded-tr-[15px] rounded-br-[15px] rounded-bl-0 bg-[#b7b7b7ff] text-white w-fit max-w-[70%] mr-auto'>
                                                            {u.message}
                                                        </div>
                                                    )
                                                }
